                  ...
                  <div class="col-sm-9">
                    ...
                    <div class="custom-control custom-radio">
                      ...
                      <label
                        ...
                        for="customRadioDisabled1"
                      >Third Radio Disabled</label>
                    </div>
                  </div>
                </div>
              </fieldset>
              ...
              <div class="form-group">
                ...
                <div class="custom-control custom-checkbox">
                  ...
                  <label
                    class="custom-control-label"
                    for="customCheck2"
                  >Check this custom checkbox 1</label>
                </div>
                <div class="custom-control custom-checkbox">
                  ...
                  <label
                    class="custom-control-label"
                    for="customCheck3"
                  >Check this custom checkbox 2</label>
                </div>
                <div class="custom-control custom-checkbox">
                  <input
                    type="checkbox"
      ...
      <div class="col-lg-12 text-center">
        <p>
          ...
          <a
            ...
            target="_blank"
          >bootstrap forms documentations.</a> and
          <a href="https://getbootstrap.com/docs/4.3/components/input-group/" target="_blank">
            bootstrap input
